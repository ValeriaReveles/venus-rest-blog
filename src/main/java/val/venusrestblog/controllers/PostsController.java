...
import val.venusrestblog.misc.FieldHelper;
import val.venusrestblog.repositories.CategoriesRepository;
import val.venusrestblog.repositories.PostsRepository;
import val.venusrestblog.repositories.UsersRepository;
import val.venusrestblog.services.EmailService;
...
//        use your user id by default:
        ...
        emailService.prepareAndSend(newPost, "Post posted by Poster", "See subject");
    }
